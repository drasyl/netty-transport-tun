 ...
 * under the License.
 */
package io.netty.contrib.transport.tun.socket.transport.tun.channel.unix;
 ...
 */
public class TunSocket extends FileDescriptor {
     ...
     */
    protected static boolean useIpv6(TunSocket socket, InetAddress address) {
    ...
    public static TunSocket newSocketStream() {
        return new TunSocket(newSocketStream0());
    }

    public static TunSocket newSocketDgram() {
        return new TunSocket(newSocketDgram0());
    }

    public static TunSocket newSocketDomain() {
        return new TunSocket(newSocketDomain0());
    }

    public static TunSocket newSocketDomainDgram() {
        return new TunSocket(newSocketDomainDgram0());
    }
